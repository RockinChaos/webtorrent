...
### [Service Worker Renderer](https://github.com/RockinChaos/webtorrent/blob/master/docs/api.md#clientloadworkercontroller-function-callback-controller---browser-only)
